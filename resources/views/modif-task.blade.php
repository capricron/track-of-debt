...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="modif-task.css">
  ...
  <body>
    ...
    <div class="form">
        ...
        <form class="text-center login" action="/task/{{$task->id}}" method="post">
          @method('PUT')
          @csrf
          <p>Nama Tugas</p>
          <input class="x no-outline" type="text" name="nama" value="{{ $task->nama }}" required>
          <br>
          <br>
          <p>Deadline Tanggal</p>
          <input type="date" class="x no-outline" name="tanggal" placeholder="" value="{{ $task->tanggal }}" required>
          <br>
          <br>
          <p>Deadline Jam</p>
